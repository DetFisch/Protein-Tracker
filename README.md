...
- Eintragsverlauf mit eingegebener Menge in Stück, Gramm oder Prozent sowie dem berechneten Protein-/Kalorienwert
...
2. Lovelace Resource hinzufügen:
   - URL: `/protein_tracker/protein-tracker-card.js?v=2.16.15`
   - Typ: `module`
